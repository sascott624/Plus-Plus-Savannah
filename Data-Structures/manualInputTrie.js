...
console.log(trie.type('c'));
console.log(trie.type('a'));
console.log(trie.type('n'));
console.log(trie.type('t'));
console.log(trie.delete());
trie.reset();
console.log(trie.type('b'));
console.log(trie.type('a'));
console.log(trie.type('t'));
console.log(trie.type('crt'));
console.log(trie.type('dar'));